  ...
  return (
    <div className="App">
      <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
        ...
        >
          ...
          >
            ...
            <br></br> <br></br>
            Soulless is an interface for creating and selling liquid wallets. A
            liquid wallet is a transferred key and is made secure by using Lit
            Protocol, an MPC programmable wallet network.
            <br></br> <br></br>
            <b>Why is it called Soulless?</b>
            <br></br> <br></br>
            Soulbound tokens are introduced as{" "}
            <b>
              <i>non transferable</i>
            </b>{" "}
            and this application shows that private keys can be securely
            tradable and as a result these tokens are no longer soul bound,
            therefore Soulless
      ...
      >
        ...
        <h1 className="text-anim" style={{ margin: 0 }}>
          SOULLESS
        </h1>
        <div
          style={{
        ...
        >
          ...
          >
            {window.account
              ? tuncateWalletAddress(window.account)
              : "Connect Wallet"}
          </Button>
        </div>
      </div>
